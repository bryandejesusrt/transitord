      ...
      body: Center(
        child: Column(
          ...
          children: [
            showError
                ? Image.asset(
                    "lib/assets/images/stop.png", // Asegúrate de tener la imagen en la carpeta assets
                    height: 100,
                    width: 100,
                  )
                : Image.asset(
                    "lib/assets/images/high-visibility-vest.png", // Asegúrate de tener la imagen en la carpeta assets
                    height: 100,
                    width: 100,
                  ),
            SizedBox(height: 20),
